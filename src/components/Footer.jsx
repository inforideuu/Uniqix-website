    ...
    <div style={{ display: 'flex', flexDirection: 'column', flexShrink: 0 }}>
      <footer
        style={{
          ...
          overflow: 'hidden',
          background: 'var(--footer-bg, #06122c)',
      ...
      >
        ...
        <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '3rem', marginBottom: '2rem' }}>
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            <p style={{ color: 'rgba(255, 255, 255, 0.85)', fontSize: '0.9rem', lineHeight: '1.6', textAlign: 'justify' }}>
          ...
          {/* Quick Links */}
          <div style={{ textAlign: 'left' }}>
            <h4 style={{ color: '#ffffff', marginBottom: '1.25rem', fontSize: '1.1rem', fontWeight: 700 }}>Solutions</h4>
          ...
          {/* Company Links */}
          <div style={{ textAlign: 'left' }}>
            <h4 style={{ color: '#ffffff', marginBottom: '1.25rem', fontSize: '1.1rem', fontWeight: 700 }}>Company</h4>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              ...
              <button onClick={() => handleNavClick('admin')} style={{ ...linkStyle, color: '#D4A72C', fontWeight: 700 }}>
                Admin Console
              </button>
            </div>
          </div>
          ...
          {/* Office Contact Info */}
          <div style={{ textAlign: 'left' }}>
            <h4 style={{ color: '#ffffff', marginBottom: '1.25rem', fontSize: '1.1rem', fontWeight: 700 }}>Global Headquarters</h4>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.75rem', color: 'rgba(255, 255, 255, 0.85)', fontSize: '0.9rem', padding: 0, margin: '0 0 1.75rem 0' }}>
              <li style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
                <MapPin style={{ width: '18px', height: '18px', color: '#D4A72C', flexShrink: 0, marginTop: '2px' }} />
                <span>8 Burn Road, Trivex #04-08, Singapore 369977.</span>
              </li>
              <li style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
                <Phone style={{ width: '18px', height: '18px', color: '#D4A72C', flexShrink: 0 }} />
                <div>
                  <div>Tel: <a href="tel:+6583995062" style={{ color: 'inherit', textDecoration: 'none' }}>+65 8399 5062</a></div>
                </div>
              </li>
            </ul>
            ...
            {/* Powered By Info */}
            <div>
              <div style={{ color: '#ffffff', fontSize: '0.95rem', fontWeight: 700, marginBottom: '0.65rem' }}>Powered By</div>
              <a
      ...
      <div
        style={{
          width: '100%',
          background: '#030918',
          borderTop: '1px solid rgba(212, 167, 44, 0.25)',
          position: 'relative',
          zIndex: 100,
          display: 'block',
          visibility: 'visible',
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Facebook */}
            <a
              href="https://facebook.com/Uniqix"
              target="_blank"
              rel="noreferrer"
              title="Facebook"
              style={{
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.color = '#ffffff';
                e.currentTarget.style.borderColor = 'rgba(212,167,44,0.3)';
            ...
            {/* Instagram */}
            <a
              href="https://instagram.com/Uniqixsg"
              target="_blank"
              rel="noreferrer"
              title="Instagram"
              style={{
            ...
            {/* LinkedIn */}
            <a
              href="https://linkedin.com/company/Uniqix"
              target="_blank"
              rel="noreferrer"
              title="LinkedIn"
              style={{
            ...
            <div style={{ fontSize: '0.92rem', color: 'var(--text-secondary)', lineHeight: '1.7', textAlign: 'justify' }}>
              {legalModal === 'terms' ? (
                ...
                <>
                  ...
                  <p>For data access requests, corrections, or privacy inquiries, please contact our Data Protection Officer at 8 Burn Road, Trivex #04-08, Singapore 369977 or email <strong>sam@uniqix.com</strong>.</p>
                </>
              )}
            </div>
